        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col md:flex-row gap-4 w-full">
            ...
            <div className={`basis-1/2`}>
              ...
              <Input className={'mt-4'} id="imageInput" type="text" placeholder={`กรุณากรอกลิงค์รูปภาพ`} value={battleField.image} onChange={onFileChangeImage} />
              {error && error.image && (
